...
export default function ContactPage() {
    ...
    const handleWhatsApp = () => {
        const message = encodeURIComponent(
            `Hi! I'm interested in your construction machinery. Here are my details:\n\n` +
        ...
        <div className="contact-container">
            ...
            <section className="contact-hero">
                <div className="hero-content">
                    <h1>Get in Touch</h1>
                    <p>
                        Ready to find the perfect machinery for your project? Our expert team
                ...
                <section className="quick-contact">
                    <div className="section-container">
                        ...
                        <div className="quick-contact-grid">
                            <button className="quick-contact-btn call-btn" onClick={handleCall}>
                            ...
                            <button className="quick-contact-btn whatsapp-btn" onClick={handleWhatsApp}>
                                <div className="btn-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <div className="quick-contact-btn email-info">
                                <div className="btn-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <section className="contact-info">
                        ...
                        <div className="info-card">
                            ...
                            <div className="department-list">
                                ...
                                <div className="department-item">
                                    <h4>Parts & Service</h4>
                                    <p>service@machinery.com</p>
                                    <p>+1-800-SERVICE</p>
                                </div>
                                <div className="department-item">
                                    <h4>Technical Support</h4>
                                    <p>support@machinery.com</p>
                                    <p>+1-800-SUPPORT</p>
                                </div>
                            </div>
                        </div>
