-- CreateEnum
CREATE TYPE "ItemType" AS ENUM ('BUY_NOW', 'REQUEST_QUOTE');
...
CREATE TABLE "cart_items" (
    ...
    "itemType" "ItemType" NOT NULL DEFAULT 'BUY_NOW',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "quote_items_quoteRequestId_productId_key" ON "quote_items"("quoteRequestId", "productId");
